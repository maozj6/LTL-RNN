...
from newloader import SequenceLoader
# 加载数据
...
device = "cuda"
# 数据加载
train_dataset = SequenceLoader(npz_file_path, 10,1,train="train")
train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True)

test_dataset = SequenceLoader(npz_file_path,10,30,train="test")
test_loader = DataLoader(test_dataset, batch_size=1, shuffle=True)


val_dataset = SequenceLoader(npz_file_path,10,1,train="val")
...
for epoch in range(epochs):
    ...
    MAX_SPEED_X = 1.3637456049097523
    MAX_SPEED_Y = 1.3799673033006457
    # 验证过程
