...
if __name__ == '__main__':
    ...
    data3 = np.load('test.npz',allow_pickle=True)
    x3 = np.array(data3['y'],dtype=np.float64)[1:]
    y3 = np.array(data3['z'],dtype=np.float64)[1:]
    ...
    plt.scatter(x3, y3, s=0.1, alpha=0.5, c='green', label='Dataset 3')  # 数据集2 - 红点
